...
MoodLog _moodLogDeserialize(
  ...
  final object = MoodLog(
    energy: reader.readLong(offsets[1]),
    isarId: id,
    mood: reader.readLong(offsets[3]),
...
extension MoodLogQueryWhereSort on QueryBuilder<MoodLog, MoodLog, QWhere> {
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhere> anyMood() {
    return QueryBuilder.apply(this, (query) {
...
extension MoodLogQueryWhere on QueryBuilder<MoodLog, MoodLog, QWhereClause> {
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> moodEqualTo(int mood) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'mood',
        value: [mood],
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> moodNotEqualTo(int mood) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> moodGreaterThan(
    int mood, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> moodLessThan(
    int mood, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> moodBetween(
    int lowerMood,
    int upperMood, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> noteIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'note',
        value: [null],
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> noteIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'note',
        lower: [null],
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> noteEqualTo(String? note) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'note',
        value: [note],
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterWhereClause> noteNotEqualTo(
      String? note) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension MoodLogQueryFilter
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterFilterCondition> energyEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'energy',
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterFilterCondition> energyGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterFilterCondition> energyLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterFilterCondition> energyBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterFilterCondition> moodEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'mood',
        value: value,
...
extension MoodLogQuerySortBy on QueryBuilder<MoodLog, MoodLog, QSortBy> {
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterSortBy> sortByEnergy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.asc);
    });
  }

  QueryBuilder<MoodLog, MoodLog, QAfterSortBy> sortByEnergyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MoodLogQuerySortThenBy
  ...
  QueryBuilder<MoodLog, MoodLog, QAfterSortBy> thenByEnergy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.asc);
    });
  }

  QueryBuilder<MoodLog, MoodLog, QAfterSortBy> thenByEnergyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.desc);
    });
  }
...
extension MoodLogQueryWhereDistinct
  ...
  QueryBuilder<MoodLog, MoodLog, QDistinct> distinctByEnergy() {
    return QueryBuilder.apply(this, (query) {
...
extension MoodLogQueryProperty
  ...
  QueryBuilder<MoodLog, int, QQueryOperations> energyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MoodLog, int, QQueryOperations> moodProperty() {
    return QueryBuilder.apply(this, (query) {
